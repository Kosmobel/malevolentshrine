const sizeY = 18; // Высота сетки
const sizeX = 27; // Ширина сетки
...
function generateCrossword() {
    placeWord("консоль", 6, 1, "vertical", "Игровое устройство для виртуального футбола");
    placeWord("сборная", 9, 1, "horizontal", "Команда, участвующая в турнире");
